...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="wrapper w-full bg-web-background font-sans mb-20"
      ref={containerRef}
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-start-gold via-end-gold to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
