...
const data = [
  {
    ...
    content: <FocusCardsDemo cards={goldBracelet} showContactUs={true} />,
  },
  {
    category: "Gold",
    title: "Rings",
    src: "/assets/images/jewelry/ring.jpeg",
    content: <FocusCardsDemo cards={goldRing} showContactUs={true} />,
  },
  {
    category: "Gold",
    title: "MangalSutra",
    src: "/assets/items/mangalsutra/mangalsutra (17).jpeg",
    content: <FocusCardsDemo cards={goldMangalsutra} showContactUs={true} />,
  },
  {
    category: "Gold",
    title: "Chain",
    src: "/assets/images/jewelry/chain.jpeg",
    content: <FocusCardsDemo cards={goldChain} showContactUs={true} />,
  },
  {
    category: "Gold",
    title: "Nose Ring",
    src: "/assets/images/jewelry/covernoseri.jpeg",
    content: <FocusCardsDemo cards={goldNoseRings} showContactUs={true} />,
  },
  {
    category: "Gold",
    title: "Earrings",
    src: "/assets/images/jewelry/earring.jpeg",
    content: <FocusCardsDemo cards={goldEarrings} showContactUs={true} />,
  },
  {
    category: "Gold",
    src: "/assets/images/jewelry/necklace.jpeg",
    title: "Necklace",
    content: <FocusCardsDemo cards={goldNecklace} showContactUs={true} />,
  },
  {
    category: "Diamond",
    src: "/assets/images/jewelry/dRings.jpeg",
    title: "Rings",
    content: <FocusCardsDemo cards={diamondRing} showContactUs={true} />,
  },
  {
    category: "Diamond",
    src: "/assets/items/dnecklace/dnecklace (6).jpeg",
    title: "Necklace",
    content: <FocusCardsDemo cards={diamondNecklace} showContactUs={true} />,
  },
];
